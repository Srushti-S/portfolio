...
// Track whether the refresh listener has been registered to avoid stacking
...
export default function setSplitText() {
  ...
  // Register the refresh listener only once — prevents duplicate listeners
  // stacking up on every resize call
